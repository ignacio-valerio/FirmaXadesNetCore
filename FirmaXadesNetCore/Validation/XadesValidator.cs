...
{
    internal abstract class XadesValidator
    {
        #region Public methods

        public static ValidationResult Validate(SignatureDocument sigDocument)
        {
                    ...
                    .Count > 0)
            {
                ...
                {
                    transform =
                        CryptoConfig.CreateFromName(timeStamp.CanonicalizationMethod.Algorithm) as
